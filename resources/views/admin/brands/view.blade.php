<x-app-layout>
    ...
    <x-bladewind::centered-content>
        ...
        <div class="grid grid-cols-5">
            <button onclick="showModal('register')" class='break-inside bg-red-500 rounded-xl p-4 mb-4 w-full col-span-2'>
                <div class='flex items-center space-x-4'>
                  ...
                  <span class='text-base font-medium text-white'>Nueva cuponera</span>
                </div>
            </button>
        </div>
